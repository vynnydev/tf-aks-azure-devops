...
from src.domain.mocks import mock_pet
...
class FindPetSpy:
    ...
    def by_pet_id(self, pet_id: int) -> Dict[bool, List[PetsModel]]:
    ...
    def by_user_id(self, user_id: int) -> Dict[bool, List[PetsModel]]:
