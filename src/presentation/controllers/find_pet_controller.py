...
from src.presentation.protocols import HttpResponse, HttpRequest
from src.utils.errors import HttpErrors


class FindPetController(ControllerInterface):
    ...
    def handle(self, http_request: Type[HttpRequest]) -> HttpRequest:
